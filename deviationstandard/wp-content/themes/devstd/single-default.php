...
<div class="page_title_ctn"> 
  <div class="wrapper table_wrapper">
    <?php # <h1><?php the_title(); </h1> #  2/25/17 DLO ?>
...
<div id="fw_c" class="fw_single_post clearfix">
    ...
    <div class="post post_single vc_row">
	  ...
	  <div class="new-h1 page_title">
	      <h1><?php the_title(); ?></h1>
 	  </div>

<?php if($post_nav !== 'no' && $bo_nav !== 'yes' ) { ?>   
    <div class="single_post_navigation">
       <?php $prev = get_permalink(get_adjacent_post(false,'',false)); if ($prev != get_permalink()) { ?><a href="<?php echo esc_url($prev); ?>" class="next_project"><?php echo __('Next', 'thefoxwp'); ?></a><?php } ?><?php $next = get_permalink(get_adjacent_post(false,'',true)); if ($next != get_permalink()) { ?><a href="<?php echo esc_url($next); ?>" class="previous_project"><?php echo __('Previous', 'thefoxwp'); ?></a><?php } ?></div>
<?php
