...
?>
   <div class="share-box">
      <ul>
        ...
        <li id="twitter"> <a  target="_blank" onClick="popup = window.open('http://twitter.com/home?status=<?php echo esc_attr($post_title); ?> <?php the_permalink(); ?>', 'PopupPage', 'height=450,width=500,scrollbars=yes,resizable=yes'); return false" href="#"><i class="fa fa-twitter"></i></a>
         </li>
        ...
        <li id="tumblr"> <a  target="_blank" onClick="popup = window.open('http://www.tumblr.com/share/link?url=<?php echo urlencode(get_permalink()); ?>&amp;name=<?php echo esc_attr($post_title); ?>&amp;description=<?php echo urlencode(get_the_excerpt()); ?>', 'PopupPage', 'height=450,width=500,scrollbars=yes,resizable=yes'); return false" href="#"><i class="fa fa-tumblr"></i></a>
         </li>
        <li id="gplus"> <a  target="_blank" onClick="popup = window.open('https://plus.google.com/share?url=<?php the_permalink(); ?>&amp;title=<?php echo esc_attr($post_title); ?>', 'PopupPage', 'height=450,width=500,scrollbars=yes,resizable=yes'); return false" href="#"><i class="fa fa-google-plus"></i></a>
         </li>
